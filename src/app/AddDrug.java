...
public class AddDrug extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Име на лекарство");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String proizv = jTextField3.getText();
        String cena = jTextField4.getText();
        String opisanie = jTextField5.getText();
        String tip = jTextField6.getText();
        String dosa = jTextField7.getText();

        query.insert("Drugs", new String[]{"drugID", "drugName", "manufacturer", "price", "desc", "type", "dosage"}, new String[]{id, ime, proizv, cena, opisanie, tip, dosa});
        jTextField1.setText("");
        jTextField2.setText("");
        jTextField3.setText("");
        jTextField4.setText("");
